#ifndef PixTestPhOptimizationPlay_H
#define PixTestPhOptimizationPlay_H

#include "PixTest.hh"


class DLLEXPORT PixTestPhOptimizationPlay: public PixTest {
public:
  PixTestPhOptimizationPlay(PixSetup *, std::string);
  PixTestPhOptimizationPlay();
  virtual ~PixTestPhOptimizationPlay();
...
private:
  ...
  ClassDef(PixTestPhOptimizationPlay, 1)
